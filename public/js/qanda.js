    ...
    subjects.forEach((subj, index) => {
        ...
        $('.getTopics').on('click', function(e){
            ...
            $('.getQues').on('click', function(e){
                ...
                $('#homeQues h3').html('<a class="waves-effect waves-light grey lighten-5 black-text btn-small left" id="toTopics"><i class="material-icons left">arrow_back</i>back</a> '+subjName);
                ...
                $('input[type="radio"]').on('change', function(e){
                    ...
                    questionArrayPosition = parseInt(quesNumInString) - 1;
                    // alert(quesNumInString)
                    let radioVal = $(this).val();
                    thisTopicsQuestions[questionArrayPosition]['userAns'] = radioVal;
                    console.log(thisTopicsQuestions);
                });
